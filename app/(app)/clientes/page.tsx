...
import { CLIENTS, ALL_APPTS } from "@/lib/data";
...
export default function ClientesPage() {
  ...
  const clientAppts = ALL_APPTS.filter((a) => a.clientId === active.id);
          ...
          <div className="bg-surface border border-line rounded-lg shadow-sm p-5">
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-4 mt-1">
                  ...
                  <span className="font-mono text-xs text-ink-3">{active.email}</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-4 gap-3 mt-5 pt-5 border-t border-line">
              {[
                ...
                { label: "Última visita", val: formatDate(active.lastVisit) },
                { label: "Promedio",      val: "$" + Math.round(active.totalSpent / active.visits).toLocaleString("es-AR") },
              ].map((s) => (
