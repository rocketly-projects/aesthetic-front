...
export default function ServiciosPage() {
  ...
  const avgPrice = Math.round(SERVICES.reduce((a, s) => a + s.price, 0) / SERVICES.length);
  const avgDuration = Math.round(SERVICES.reduce((a, s) => a + s.duration, 0) / SERVICES.length);
